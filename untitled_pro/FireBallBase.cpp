...
QTimer *FireBallBase::attackTimer = nullptr;
    ...
    : QObject{parent}, m_scene(scene), m_speed(speed_), m_damage(damage_), m_penetration(penetration_)
{
    ...
    // 计时器绑定
    connect(attackTimer, &QTimer::timeout, this, &FireBallBase::enemyHitCheck);
    connect(attackTimer, &QTimer::timeout, this, &FireBallBase::move);
